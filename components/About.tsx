...
function About({}: Props) {
  return (
    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.5}} className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <p className='text-base'>Lorem ipsum, dossasasadsdsdlor skdldfit amet consectetur adipisicing elit. Nemo nostrum, impedit laudantium labore officiis eveniet maiores aspernatur aperiam molestias! Velit exercitationem ratione incidunt ab labore corporis autem dolor doloribus quae!</p>
